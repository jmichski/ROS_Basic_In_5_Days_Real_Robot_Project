...
SIM_FAST_FORWARD_OBJECT_AVOID_DISTANCE = 0.49
SLOW_FORWARD_OBJECT_AVOID_DISTANCE = 0.45
...
class LogLapClass(object):
    ...
    _running_total        = 0.0   # incremental total — used for min distance lap check
    ...
    def check_lap_complete(self):
        ...
        Requires LAP_CHECK_MIN_DISTANCE travelled to prevent false trigger at startup."""
